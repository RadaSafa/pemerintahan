...
<header class="nav-holder make-sticky" >
  ...
  <div class="blogger">
      ...
      <div id="content" class="eightcol first ghost blogger">
  		...
  		<div class="item_inn p-border post-5114 page type-page status-publish hentry">

              <div class="entry">

                      <h1 class="post entry-title">Arti Lambang</h1>

                      <div class="hrlineB p-border"></div>

                      <p><img src="assets/kecamatan/artilambang.jpg" width="90%" height="400" style="padding-left:100px"></p>
  <p>&nbsp;</p>
  <p align="justify">Warna Lambang Daerah terdiri dari biru muda, kuning emas, biru tua, merah, putih, hijau, coklat dan hitam, yang masing-masing warna melambangkan :</p>
  <ol>
  <li><strong>Biru Muda</strong> melambangkan perubahan, kejujuran, kemakmuran, ketaatan dan takwa;</li>
  <li><strong>Kuning Emas</strong> melambangkan keagungan dan kejayaan serta kebesaran cita dan masyarakat untuk membangun daerah dan negaranya;</li>
  <li><strong>Biru Tua</strong> melambangkan laut, kesetiaan, ketekunan dan ketabahan juga melambangkan kekayaan sungai dan lautan yang merupakan sumber perikanan dan kehidupan para nelayan;</li>
  <li><strong>Merah</strong> melambangkan keberanian dan kedinamisan;</li>
  <li><strong>Putih</strong> melambangkan kesucian;</li>
  <li><strong>Hijau</strong> melambangkan kesejahteraan dan kecerdasaan; dan</li>
  <li><strong>Coklat</strong> melambangkan tanah yang subur untuk ladang dan sawah.</li>
  </ol>
  <p>&nbsp;</p>
  <p>Isi Lambang Daerah mempunyai makna terdiri atas :</p>
  <ol>
  <li>Tulisan <strong>Lampung Selatan</strong> berarti Daerah Kabupaten Lampung Selatan<strong>;</strong></li>
  <li><strong>Pita Berwarna Merah</strong> melambangkan keberanian;</li>
  <li><strong>Bintang Emas Bersegi 5 (lima) </strong>melambangkan nilai-nilai keagamaan;</li>
  <li><strong>Siger </strong>melambangkan mahkota keagungan adat budaya dan tingkat kehidupan terhormat;</li>
  <li><strong>Bergerigi 7 (tujuh)</strong> melambangkan 7 (tujuh) marga yakni : Marga Pesisir/Rajabasa, Marga Legun, Marga Katibung, Marga Dantaran, Marga Ratu, Marga Sekampung Ilir, dan Marga Sekampung Udik;</li>
  <li><strong>Setangkai Padi</strong> berjumlah 14 (empat belas) bulir, Kapas berjumlah 11 (sebelas) tangkai, Mutiara pada Siger berjumlah 56 (lima puluh enam) butir, merujuk pada hari jadi Kabupaten Lampung Selatan 14 November 1956;</li>
  <li><strong>Gunung, Laut, Daratan, dan Pohon Kelapa</strong> melambangkan kekayaan alam;</li>
  <li>Aksara Lampung <strong>Khagom Mufakat </strong>yang berarti suka bermusyawarah untuk menuju mufakat;</li>
  <li>Sebuah <strong>Badik</strong> melambangkan keperwiraan;</li>
  </ol>
  <p>&nbsp;</p>
  <p>Unduh Lambang Daerah Kabupaten Lampung Selatan, silahkan <a href="https://www.lampungselatankab.go.id/sites/wp-content/uploads/2018/03/LOGO-KABUPATEN-LAMPUNG-SELATAN.png" rel='prettyPhoto'>klik di sini</a>.</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
