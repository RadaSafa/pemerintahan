...
<header class="nav-holder make-sticky" >
  ...
  <div class="blogger">
      ...
      <div id="content" class="eightcol first ghost blogger">
  		...
  		<div class="item_inn p-border post-5116 page type-page status-publish hentry">

              <div class="entry">

                      <h1 class="post entry-title">Visi dan Misi</h1>

                      <div class="hrlineB p-border"></div>

                    <p style="text-align: center;"><strong>VISI</strong></p>
                    <ol>
                    <li>Terwujudnya Kabupaten Lampung Selatan yang Sejahtera, Berdaya Saing, Mandiri dan Berakhlak Mulia</li>
                      </ol>

  <p>&nbsp;</p>
  <p style="text-align: center;"><strong>MISI</strong></p>
  <ol>
  <li>Membangun infrastruktur untuk mempercepat kemajuan desa sesuai dengan tata ruang wilayah;</li>
  <li>Meningkatkan kualitas sumber daya manusia melalui pelayanan pendidikan dan kesehatan yang baik, terjangkau dan proaktif;</li>
  <li>Membangun perekonomian daerah dengan memperkuat ekonomi berbasis kerakyatan dan perdesaan yang berwawasan lingkungan dan berkelanjutan;</li>
  <li>Mewujudkan kehidupan masyarakat yang damai, menjunjung tinggi hukum, demokratis dan memberdayakan perempuan berlandaskan nilai agama dan budaya;</li>
  <li>Mewujudkan tata kelola pemerintahan yang bersih, akuntabel, efektif dan professional.</li>
  </ol>
  <h4></h4>
  <p style="text-align: center;"><strong>PROGRAM PRIORITAS</strong></p>
  <ol>
  <li>Penyelenggaraan infrastruktur jalan dan transportasi;</li>
  <li>Pengembangan dan pembinaan pemukiman;</li>
  <li><span style="display: inline !important; float: none; background-color: transparent; color: #333333; font-family: Georgia,'Times New Roman','Bitstream Charter',Times,serif; font-size: 16px; font-style: normal; font-variant: normal; font-weight: 400; letter-spacing: normal; line-height: 24px; orphans: 2; text-align: left; text-decoration: none; text-indent: 0px; text-transform: none; -webkit-text-stroke-width: 0px; white-space: normal; word-spacing: 0px; word-wrap: break-word;">Penyediaan air minum, sanitasi dan persampahan;</span></li>
  <li>Bina pembangunan desa;</li>
  <li>Penataan ruang wilayah;</li>
  <li>Pengelolaan pertanahn;</li>
  <li>Pengembangan komunikasi dan informatika.</li>
  </ol>
