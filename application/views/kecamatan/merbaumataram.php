...
<header class="nav-holder make-sticky" >
  ...
  <div class="blogger">
      ...
      <div id="content" class="eightcol first ghost blogger">
  		...
  		<div class="item_inn p-border post-5650 page type-page status-publish hentry">

              <div class="entry">

                      <h1 class="post entry-title">Kecamatan Merbau Mataram</h1>

                      <div class="hrlineB p-border"></div>

                      <div class="su-gmap su-responsive-media-yes"><iframe width="600" height="400" src="//maps.google.com/maps?q=Merbau+Mataram%2C+South+Lampung+Regency%2C+Lampung&amp;output=embed"></iframe></div>
