...
<header class="nav-holder make-sticky" >
  ...
  <div class="blogger">
      ...
      <div id="content" class="eightcol first ghost blogger">
  		...
  		<div class="item_inn p-border post-5235 page type-page status-publish hentry">

              <div class="entry">

                      <h1 class="post entry-title">Kecamatan Kalianda</h1>

                      <div class="hrlineB p-border"></div>

                      <div class="su-gmap su-responsive-media-yes"><iframe width="100%" height="500" src="//maps.google.com/maps?q=Kalianda&amp;output=embed"></iframe></div>
  <p>&nbsp;</p>
  <p><b>Kecamatan Kalianda</b> adalah sebuah tempat di mana ibukota Kabupaten Lampung Selatan berada, Kota Kalianda yang juga berfungsi sebagai pusat dari Kecamatan ini terletak sekitar 60 km dari Kota Bandar Lampung, Ibukota Provinsi Lampung.</p>
  <p>Memiliki luas wilayah sebesar 179,82 km<sup>2 </sup>,Kecamatan Kalianda terdiri dari 25 desa dan 4 kelurahan. Tercatat pada tahun 2014 Kecamatan Kalianda dihuni oleh 116.157 jiwa atau 9,22% dari total penduduk Kabupaten Lampung Selatan.</p>
  <p>Berikut nama desa dan kelurahan yang terletak di Kecamatan Kalianda :</p>
  <ol>
  <li>Kelurahan Kalianda</li>
  <li>Kelurahan Way Urang</li>
  <li>Kelurahan Bumi Agung</li>
  <li>Kelurahan Wai Lubuk</li>
  <li>Desa Agom</li>
  <li>Desa Babulang</li>
  <li>Desa Buah Berak</li>
  <li>Desa Bulok</li>
  <li>Desa Canggu</li>
  <li>Desa Gunung Terang</li>
  <li>Desa Hara Banjar Manis</li>
  <li>Desa Jondong</li>
  <li>Desa Kecapi</li>
  <li>Desa Kedaton</li>
  <li>Desa Kesugihan</li>
  <li>Desa Maja</li>
  <li>Desa Marga Catur</li>
  <li>Desa Merak Belantung</li>
  <li>Desa Munjuk Sempurna</li>
  <li>Desa Negeri Pandan</li>
  <li>Desa Palembapang</li>
  <li>Desa Pauh Tanjung Iman</li>
  <li>Desa Pematang</li>
  <li>Desa Sukaratu</li>
  <li>Desa Sukatani</li>
  <li>Desa Sumur Kumbang</li>
  <li>Desa Tajimalela</li>
  <li>Desa Taman Agung</li>
  <li>Desa Tengkujuh</li>
  </ol>
  <p>&nbsp;</p>
  <span class="su-frame su-frame-align-center su-frame-style-default"><span class="su-frame-inner"><img class="alignnone" src="https://www.lampungselatankab.go.id/sites/wp-content/uploads/2018/02/kubah-intan.jpg" alt="" width="100%" height="500" /></span></span>
  <p>Letak wilayahnya yang berada di kaki gunung Rajabasa dan pesisir pantai  membuat kecamatan ini dianugerahi objek-objek pariwisata alam yang indah. Pemandian air panas Way Belerang, Dermaga Bom, Pantai Kedu, Pantai Embe, Pantai Laguna Helau adalah sebagian dari objek wisata alam yang indah dan layak dikunjungi.</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
