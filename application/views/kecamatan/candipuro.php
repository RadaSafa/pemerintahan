...
<header class="nav-holder make-sticky" >
  ...
  <div class="blogger">
      ...
      <div id="content" class="eightcol first ghost blogger">
  		...
  		<div class="item_inn p-border post-5616 page type-page status-publish hentry">

              <div class="entry">

                      <h1 class="post entry-title">Kecamatan Candipuro</h1>

                      <div class="hrlineB p-border"></div>

                      <div class="su-gmap su-responsive-media-yes"><iframe width="100%" height="500" src="//maps.google.com/maps?q=Candipuro%2C+South+Lampung+Regency%2C+Lampung&amp;output=embed"></iframe></div>
...
<p>&nbsp;</p>
  <ul type="1">
    <li><b>Letak Geografis Kecamatan Candipuro</b>
        <p align="justify">
          Kecamatan Candipuro merupakan salah satu bagian dari wilayah Kabupaten Lampung Selatan dengan membawahi 14 Desa dengan luas wilayah 117.47 Km2, dan dihuni oleh sebagaian besar suku pendatang.
          Kecamatan Candipuro berbatasan dengan :
          <ul type="a">
            <li>Sebelah Utara berbatasan dengan Kecamatan Katibung Kabupaten Lampung Selatan</li>
            <li>Sebelah Selatan berbatasan dengan Kecamatan Way Panji Kabupaten Lampung Selatan</li>
            <li>Sebelah Barat berbatasan dengan Kecamatan Sidomulyo Kabupaten Lampung Selatan</li>
            <li>Sebelah Timur berbatasan dengan Kecamatan Jabung Kabupaten Lampung Timur</li>
          </ul>
        </p>
    </li>
    <li><b>Topografis</b>
      <p align="justify">
        Secara topografis wilayah Kecamatan Candipuro sebagian besar bentuk permukaan tanah adalah dataran rendah dengan ketinggian dari permukaan laut kurang dari 100 m.
      </p>
    </li>
    <li><b>Administrasi Pemerintahan</b>
      <p align="justify">
        Kecamatan Candipuro terbentuk berdasarkan dari program pemekaran Kecamatan Sidomulyo yang berstatus perwakilan Kecamatan Candipuro, Berdasarkan Surat Keputusan Gubernur Kepala Daerah Tingkat I Lampung Nomor : G/35/B.II/HK/1990, tanggal 27 Agustus 1990 dengan persetujuan Menteri Dalam Negeri Nomor : 138/1443/FUOD/1991 tanggal 24 April 1991.  Selanjutnya berdasarkan Perda Nomor : 42
        Kabupaten Lampung Selatan pada tanggal 26 Februari 2000 Kecamatan Perwakilan Candipuro diresmikan menjadi Kecamatan definitif yaitu Kecamatan Candipuro.
        Untuk mewujudkan pelaksanaan Pemerintah berdasarkan surat keputusan MENDAGRI Nomor : 82/83 tahun 1984  tentang Susunan Organisasi dan Tatakerja Wilayah Kecamatan :
        <ul type="1">
        ...
        Camat Candipuro setelah definitif adalah sebagai berikut :
        <table class="table table-bordered table-hover table-condensed">
        <thead>
        <tr>
        <th title="Field #1" width="10"><strong><p align="center">No</p></strong></th>
        <th width="250" align="center" title="Field #2"><strong>Nama</strong></th>
        </tr>
        </thead>
        <tbody>
        <tr>
        <td align="center">1</td>
        <td><strong>DJUNAEDI BASRI,BA</strong></td>
        </tr>
        <tr>
        <td align="center">2</td>
        <td><strong>Drs. Ansori Syahrie</strong></td>
        </tr>
        <tr>
        <td align="center">3</td>
        <td><strong>Drs. Hermanto</strong></td>
        </tr>
        <tr>
        <td align="center">4</td>
        <td><strong>Drs A.Shomad ,MS</strong></td>
        </tr>
        <tr>
        <td align="center">5</td>
        <td><strong>Ridwan, BA</strong></td>
        </tr>
        <tr>
        <td align="center">6</td>
        <td><strong>Drs. Mukhlan</strong></td>
        </tr>
        <tr>
    ...
    <li><b>Penduduk</b>
      <p align="justify">
        Penduduk yang berdomisili di Kecamatan Candipuro, secara garis besar penduduk pendatang.
        Sementara penduduk pendatang sebagai mayoritas, sebagian besar berasal dari Pulau Jawa (Jawa Barat, Jawa Tengah, Jawa Timur dan Yogyakarta). Selain itu ada juga yang berasal dari Bali,), dan juga dari propinsi lain di Pulau Sumatera, seperti Sumatera Barat (Minang), Sumatera Utara (Batak), Sumatera Selatan (Semendo), dan lain-lain.
      </p>
  <ul>
</div>
